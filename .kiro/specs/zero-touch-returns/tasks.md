...
- [x] 8. API layer for the demo
  - [x] 8.1 Implement Express API routes for the return flow
...
- [x] 9. React frontend — hero-path screens
  - [x] 9.1 Scaffold React app shell and routing
  ...
  - [x] 9.2 Build the eligibility result screen
  ...
  - [x] 9.3 Build the reason picker screen
  ...
  - [x] 9.4 Build the guided media capture screen
  ...
  - [x] 9.5 Build the live grading progress screen
  ...
  - [x] 9.6 Build the disposition result screen (refund estimate + explanation)
  ...
  - [x] 9.7 Wire frontend to API and verify full hero-path flow in browser
